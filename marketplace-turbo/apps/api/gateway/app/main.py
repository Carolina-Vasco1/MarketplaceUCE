...
from .routes.admin_users_proxy import router as admin_users_proxy_router
from .routes.admin_products_proxy import router as admin_products_proxy_router
from .routes.paypal_proxy import router as paypal_proxy_router
from .routes.config import router as config_router
from .routes.proxy import router
from .routes.orders_proxy import router as orders_proxy_router
